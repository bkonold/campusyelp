...
covelLunch = [i for it, i in enumerate(lunchSet1[1:]) if it%2 == 0]
deNeveLunch = [i for it, i in enumerate(lunchSet1[1:]) if it%2 == 1]
feastLunch = [i for it, i in enumerate(lunchSet2[1:]) if it%2 == 0]
bpLunch = [i for it, i in enumerate(lunchSet2[1:]) if it%2 == 1]
